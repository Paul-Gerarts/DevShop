...
public class UserControllerTest {
    ...
    void testRetrieveAllUserEndpoint() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$[0].archivedShopOrders[0].products[0].name").value(equalTo("test")))
                .andExpect(jsonPath("$[0].archivedShopOrders[0].products[0].price").value(equalTo(55.99)))
                .andExpect(jsonPath("$[0].archivedShopOrders[0].products[1].name").value(equalTo("product")))
                .andExpect(jsonPath("$[0].archivedShopOrders[0].products[1].price").value(equalTo(110)))
                .andExpect(jsonPath("$[0].archivedShopOrders[0].finalizedCart").value(equalTo(false)))
                .andExpect(jsonPath("$[0].archivedShopOrders[0].paidCart").value(equalTo(false)))
                .andExpect(jsonPath("$[0].archivedShopOrders[1].products[0].name").value(equalTo("test")))
                .andExpect(jsonPath("$[0].archivedShopOrders[1].products[0].price").value(equalTo(55.99)))
                .andExpect(jsonPath("$[0].archivedShopOrders[1].products[1].name").value(equalTo("product")))
                .andExpect(jsonPath("$[0].archivedShopOrders[1].products[1].price").value(equalTo(110)))
                .andExpect(jsonPath("$[0].archivedShopOrders[1].finalizedCart").value(equalTo(true)))
                .andExpect(jsonPath("$[0].archivedShopOrders[1].paidCart").value(equalTo(true)))
                ...
                .andExpect(jsonPath("$[1].archivedShopOrders[0].products[0].name").value(equalTo("test")))
                .andExpect(jsonPath("$[1].archivedShopOrders[0].products[0].price").value(equalTo(55.99)))
                .andExpect(jsonPath("$[1].archivedShopOrders[0].products[1].name").value(equalTo("product")))
                .andExpect(jsonPath("$[1].archivedShopOrders[0].products[1].price").value(equalTo(110)))
                .andExpect(jsonPath("$[1].archivedShopOrders[0].finalizedCart").value(equalTo(false)))
                .andExpect(jsonPath("$[1].archivedShopOrders[0].paidCart").value(equalTo(false)))
                .andExpect(jsonPath("$[1].archivedShopOrders[1].products[0].name").value(equalTo("test")))
                .andExpect(jsonPath("$[1].archivedShopOrders[1].products[0].price").value(equalTo(55.99)))
                .andExpect(jsonPath("$[1].archivedShopOrders[1].products[1].name").value(equalTo("product")))
                .andExpect(jsonPath("$[1].archivedShopOrders[1].products[1].price").value(equalTo(110)))
                .andExpect(jsonPath("$[1].archivedShopOrders[1].finalizedCart").value(equalTo(true)))
                .andExpect(jsonPath("$[1].archivedShopOrders[1].paidCart").value(equalTo(true)))
                ...
                .andExpect(jsonPath("$[2].archivedShopOrders[0].products[0].name").value(equalTo("test")))
                .andExpect(jsonPath("$[2].archivedShopOrders[0].products[0].price").value(equalTo(55.99)))
                .andExpect(jsonPath("$[2].archivedShopOrders[0].products[1].name").value(equalTo("product")))
                .andExpect(jsonPath("$[2].archivedShopOrders[0].products[1].price").value(equalTo(110)))
                .andExpect(jsonPath("$[2].archivedShopOrders[0].finalizedCart").value(equalTo(false)))
                .andExpect(jsonPath("$[2].archivedShopOrders[0].paidCart").value(equalTo(false)))
                .andExpect(jsonPath("$[2].archivedShopOrders[1].products[0].name").value(equalTo("test")))
                .andExpect(jsonPath("$[2].archivedShopOrders[1].products[0].price").value(equalTo(55.99)))
                .andExpect(jsonPath("$[2].archivedShopOrders[1].products[1].name").value(equalTo("product")))
                .andExpect(jsonPath("$[2].archivedShopOrders[1].products[1].price").value(equalTo(110)))
                .andExpect(jsonPath("$[2].archivedShopOrders[1].finalizedCart").value(equalTo(true)))
                .andExpect(jsonPath("$[2].archivedShopOrders[1].paidCart").value(equalTo(true)));
